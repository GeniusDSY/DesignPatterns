...
![](https://user-gold-cdn.xitu.io/2019/3/24/169ae0d57bdd5bf3?w=867&h=393&f=png&s=209767)

###　时序图

![](https://user-gold-cdn.xitu.io/2019/3/24/169ae0db7744fbad?w=643&h=306&f=png&s=89149)
...
在Windows上面使用这个系统的用户看到的是Windows用户界面的视感；而一个在Macintosh上面使用的用户看到的则是Macintosh用户界面的视感，Java语言是通过所谓的Peer架构做到这一点的。
